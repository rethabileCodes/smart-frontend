...
class MyLockers extends React.Component{
        ...
        return (
            <div >
                <GridList cellHeight={180}  >
                    ...
                    {this.props.myLockers && this.props.myLockers.map(tile => (
...
function mapStateToProps({myLockers}){
    return {myLockers}
}
export default connect(mapStateToProps,null)(MyLockers);